      ...
      <div className="container mx-auto py-14 grid gap-10 md:grid-cols-4">
        <div>
          <div className="flex items-center gap-3 mb-4">
            <img src={logo} alt="Shreepad logo" className="h-12 w-12" />
            <div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-white/70">
            ...
            <li className="flex items-start gap-2"><MapPin className="h-4 w-4 text-accent mt-1" /> PCMC & Pune, Maharashtra</li>
          </ul>
        </div>
